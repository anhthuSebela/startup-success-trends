...
#html_text = requests.get('https://www.greatcollections.com/hotlist.php?cmd=hotlist&date=2022-3-27&cat_id=25&cat_name=Silver-Eagles').text
#soup = BeautifulSoup(html_text, 'lxml')
#text_box = soup.find('tr', class_ = 'alt1')
#text = text_box.find('a', href = "https://www.greatcollections.com/Coin/1135536/1986-1-Silver-Eagle-NGC-MS-70").text
#print(text)
